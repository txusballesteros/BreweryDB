...
class GetBeerByIdInteractor @Inject constructor(executor: ExecutorService,
                                                private val repository: BeersRepository):
                            AnkoUseCase<Beer>(executor), GetBeerByIdUseCase {
  lateinit private var beerId: String
  ...
  override fun onExecute(onResult: (Beer) -> Unit) {
    repository.get(beerId, {
      onResult(it)
    })
  }
}